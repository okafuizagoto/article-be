...
// 	"article-be/internal/entity/article"
...
// 			// TODO: mapping after → entity, panggil res.ArticleSvcLocal atau service lain
// 			//---------------------------------------------------------------------
...
// 			_, err := res.ArticleSvcProd.InsertGoldUser(ctx, user)
// 			return err
// 			//---------------------------------------------------------------------
// 		case "u":
...
// 			_, err := res.ArticleSvcLocal.InsertGoldUser(ctx, user)
// 			return err
...
import (
	...
	goldgym "article-be/internal/entity/article"
	"article-be/internal/resources"
)
...
func handleUsers(res *resources.BootResources) HandlerFunc {
	...
	return func(ctx context.Context, op string, after, before map[string]interface{}) error {
		...
		case "u":
			...
			// 	return err
			// }
			// _, err := res.ArticleSvcProd.UpdateGoldUser(ctx, user)
			var err error
			return err
		...
		case "d":
			...
			// 	return err
			// }
			// return res.ArticleSvcProd.DeleteGoldUser(ctx, user.ID)
			var err error
			return err
...
func handleGoldGym(res *resources.BootResources) HandlerFunc {
	...
	return func(ctx context.Context, op string, after, before map[string]interface{}) error {
		...
		case "c":
			...
			// _, err := res.ArticleSvcLocal.InsertGoldUser(ctx, g)
			return err
