...
func getDefaultConfigFile() string {
	configPath := "./files/etc/article-be/article-be.development.yaml"
	...
	if env != "" {
		...
		case envProduction:
			...
			configPath = "/vault/secrets/database.yaml"
		default:
			configPath = "./article-be.development.yaml"
		}
	}
...
func getCredentialsFile() string {
	configPath := "./files/etc/article-be/credentials.development.json"
	namespace, _ := ioutil.ReadFile("/var/run/secrets/kubernetes.io/serviceaccount/namespace")
